...
You can't edit existing NPC dialogue, but you can add new responses to existing dialogue that kick off new dialogue and missions. Here is a working example from DinoMod:
